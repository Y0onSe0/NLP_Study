...
| full training | `train_dev` | train, dev | direct prompt로 최종 checkpoint 재학습 |
| dev single-direction | `dev_predict` | dev | threshold 0.5 단방향 dev 성능 확인 |
...
python paraphrase_detection.py --use_gpu --mode calibrate_dev \
  ...
  --para_dev_out predictions/rerun-20260611/para-dev-full-direct-bi-calib.csv \
  --experiment_log results/rerun-20260611/paraphrase_experiments.csv
